...
if (SERVER) then
	resource.AddFile("materials/pistachio/skin"..REVISION..".png");
...
SKIN.PrintName = "Pistachio Skin";
SKIN.Author = "Chessnut";
SKIN.DermaVersion = 1;
SKIN.GwenTexture = Material("pistachio/skin"..REVISION..".png");
...
SKIN.Colours.TooltipText	= Color(255, 255, 255, 250); --GWEN.TextureColor( 4 + 8 * 26, 500 );
...
derma.DefineSkin("Pistachio", "A GWEN skin for the Pistachio gamemode.", SKIN);